            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <sf:form method="post" modelAttribute="newUser">
                      <span style="color: #f0ffff; ">   Login: </span><sf:input path="login"/><br/>
                       <span style="color: #f0ffff; ">  Password: </span><sf:password path="password"/><br/>
                       <span style="color: #f0ffff; ">  Phone number:</span> <sf:input path="phonenumber"/><br/>
                        <span style="color: #f0ffff; "> E-mail:</span> <sf:input path="email"/><br/>
                        <input type="submit" class="button button1" value="Reg"/>
