        ...
        <td bgcolor="#000000"><table align="left" valign="top"  width="770" height="1000" border="0" cellspacing="0">
            ...
            <tr align="center" valign="top">
                <td bgcolor="#000000"  ><table width="760" border="0" cellspacing="0" align="center" valign="top">
                    ...
                    <security:authorize access="hasRole('ROLE_USER'))"> <security:authentication property="username"/></security:authorize>
                    <form:form>
                        ...
                        <input type="submit" name="_eventId_adressentered" class="button button1" value="введите Имя" />
                    </form:form>
